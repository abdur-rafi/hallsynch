...
import { AttachedFiles, Batch, Department, NewApplication, NewSeatQuestionnaire, ResidencyStatus, Room, SeatApplication, Student, TempApplication, TempQuestionnaire } from "../../graphql-schema";
